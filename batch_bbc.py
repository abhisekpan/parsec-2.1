#!/usr/bin/python
"""Runs the basic block collection pin tool in batch, for Parsec programs"
...
for bm in benchmarks:
    ...
    for input_size in inputs:
        ...
        outfilepath = (dirname + "/" + group + "/" + bm + "/" +
                         output_file)
        if os.path.exists(outfilepath):
            shutil.copy(outfilepath, "~/rda_out/")
